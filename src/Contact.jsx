...
<div>    
    ...
    onClick = {handleMail} transition = {{type: 'spring', duration: 1}} > aparnagupta813@gmail.com  </motion.span></p>
        ...
        <div className='text-black font-bold  text-xl lg:text-4xl flex' ref= {ref} > 
          ...
          <motion.div variants = {{none: {y: 0}, jump: {y : [70, 0]} }}  intiial = "none" animate = {elementJump}  transition = {{type: 'spring', duration: 0.5, delay:0.8, stiffness: 400}} className = "mr-1.5 lg:mr-3" > build  </motion.div> 
          <motion.div variants = {{none: {y: 0}, jump: {y : [-80, 0]} }}  intiial = "none" animate = {elementJump}  transition = {{type: 'spring', duration: 0.5, delay:0.9, stiffness: 400}} className = "mr-1.5 lg:mr-3" > your  </motion.div> 
          <motion.div variants = {{none: {y: 0}, jump: {y : [70, 0]} }}  intiial = "none" animate = {elementJump}  transition = {{type: 'spring', duration: 0.5, delay:1, stiffness: 400}} className = "mr-1.5 lg:mr-3" > website  </motion.div> 
     ...
     variants = {{parked : {x : 0}, moved: {x: 800}}}  intial = 'parked'  >  <img src='https://cdn.gamedevmarket.net/wp-content/uploads/20191203194912/ef01b7965d29e9c56b0326706dbd58c6953af9a5.gif' className='w-48 h-48 hidden lg:block' /></motion.div>
     <motion.div  ref= {ref}  whileHover =  {{x: 210}} transition = {{duration : 10, type: 'spring', delay: 0}} 
     variants = {{parked : {x : 0}, moved: {x: 210}}}  intial = 'parked'  >  <img src='https://cdn.gamedevmarket.net/wp-content/uploads/20191203194912/ef01b7965d29e9c56b0326706dbd58c6953af9a5.gif' className='w-48 h-48 block lg:hidden' /></motion.div>
