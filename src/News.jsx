...
<div className='flex'> <Link  to= "https://github.com/aparn-gupta/GnewsApp" target='_blank' ><motion.div whileHover = {{scale: 1.19}}  transition = {{type: 'spring', stiffness: 400,   duration: 1}}   >   <button className=' h-14 w-36 mt-8 
...
<div className=' hidden h-14 w-8 border-2 border-b-black border-r-black mt-8   '> </div></div>
   ...
   <Link to = "https://gnews-app.vercel.app/" target='_blank' className='block lg:hidden' >  <img src= {image8}  className='w-96 h-72 mt-20 border-2 border-slate-100 rounded-2xl  object-contain hover:shadow-2xl' /> </Link>
