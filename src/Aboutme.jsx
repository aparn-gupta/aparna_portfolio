    ...
    <div className='bg-black'>
        <div className='w-screen h-300 relative '>
         ...
         <div className=' text-white text-lg absolute top-0 left-0 w-screen '>
          ...
          <ul  className='mt-12 flex justify-between w-1/3' >
          ...
          <div className='w-2/3' >
           <h1 className='font-bold w-1/2 text-3xl mt-20 bg-gradient-to-r from-slate-600 via-lime-400 to-lime-900 text-transparent bg-clip-text mb-10'> LICENSES AND CERTIFICATIONS </h1>
        ...
        <p className='font-bold text-xl '> React.js Essential Training </p> 
          ...
          <p className='font-bold text-xl  '> JavaScript Essential Training </p> 
            ...
            <div  className='w-screen bg-black pb-16 pt-4 flex justify-center' >
       ...
       <div className='flex justify-between text-lime-400 w-1/5 mt-6'   id = "footer-contacts" >
