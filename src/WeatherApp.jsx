...
import image7 from './assets/weather.png';
...
const WeatherApp = () => {
  ...
  return (
    ...
    <Link to = "https://weather-app-xi-gules-50.vercel.app/" target='_blank' >  <img src= {image7}  className='w-96 h-72 mt-20 border-2 border-slate-100 rounded-2xl  object-contain hover:shadow-2xl' /> </Link>
...
<div className='flex'> <Link  to= "https://github.com/aparn-gupta/Weather-App/" target='_blank' ><motion.div whileHover = {{scale: 1.19}}  transition = {{type: 'spring', stiffness: 400,   duration: 1}}   >   <button className=' h-14 w-36 mt-8 
